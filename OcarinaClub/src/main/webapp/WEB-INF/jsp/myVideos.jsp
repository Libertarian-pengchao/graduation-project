...
<div class="container-fluid">
	<div class="page-header">
		<span class="brand">我的视频</span>
		<a href="<%=response.encodeURL(request.getContextPath() + "/uploadMyVideoView") %>" class="brand1">上传视频</a>
	</div>
	<div class="container">
		<div class="row">
		<c:forEach items="${videos}" var="m">
			<div class="col-md-3 vidcontainer" style="margin-right: 40px;margin-top: 20px;cursor: pointer;">
				...
				<a href="/OcarinaClub/myVideoDelete?id=${m.id}&videoname=${m.vidieoName}" class="hidden delete" onclick="return confirm('确认删除吗？')">删除</a>
			</div>
		</c:forEach>
	</div>
	</div>
