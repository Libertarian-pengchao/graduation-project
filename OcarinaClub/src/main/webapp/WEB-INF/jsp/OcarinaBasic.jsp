...
<body>
	...
	<div class="container">
		<c:forEach items="${allOcarinaskills }" var="allOcarina">
			<div class="" style="margin-bottom: 20px;">
				<div class="row">
					<a href="<%=request.getContextPath()%>/skillsdetail?id=${allOcarina.id}"><h3>${allOcarina.title }</h3></a>
				</div>
				<div class="row" style="font-size:18px;">
					<div>${allOcarina.content }</div>
				</div>
			</div>
		</c:forEach>
	</div>
