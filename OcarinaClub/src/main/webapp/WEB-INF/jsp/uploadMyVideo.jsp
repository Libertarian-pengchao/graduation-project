...
<body>
	<div class="container-fluid">
		<div class="page-header">
			<span class="brand">上传视频</span>
		</div>
		
		<div class="row">
			<div class="col-md-6 col-md-offset-2">
				<form class="form-horizontal" action="<%=response.encodeURL(request.getContextPath() + "/videoUpload")%>" method="post" enctype="multipart/form-data">
					...
					<div class="form-group">
						<label for="img" class="col-md-4 control-label">选择视频：</label>
						<div class="col-md-6">
